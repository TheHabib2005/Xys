...
import { CloudUpload,  CheckCircle2, ChevronDown } from "lucide-react";
        ...
        <div className="flex items-center gap-3">
         ...
         <div className="relative" ref={dropdownRef}>
            <button
              ...
              className="flex items-center gap-2 px-5 py-2 bg-primary text-primary-foreground hover:bg-primary/90 rounded-md text-sm font-medium shadow-sm transition-all disabled:opacity-50"
            >
              Post Options
            ...
            <AnimatePresence>
              {isMenuOpen && (
                <motion.div
                  ...
                  className="absolute right-0 mt-2 w-56 origin-top-right bg-card border border-border rounded-xl shadow-xl z-50 overflow-hidden backdrop-blur-xl"
                >
                  <div className="p-1.5 space-y-1">
                    ...
                    >
                      ...
                      <div className="text-left">
                        <p>Save as Draft</p>
                        <p className="text-[10px] text-muted-foreground/60 font-normal">Keep it private for now</p>
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div className="text-left">
                        <p className="text-foreground">Publish Now</p>
                        <p className="text-[10px] text-muted-foreground/60 font-normal">Make this post live</p>
                      </div>
                    </button>
                  </div>
                </motion.div>
          ...
          >
            ...
            <div className="text-center">
              <h3 className="text-lg font-bold tracking-tight">
                {type === "publish" ? "Publishing Post" : "Saving Draft"}
              </h3>
              <p className="text-sm text-muted-foreground mt-1">
                {type === "publish" 
                  ? "Making your masterpiece live..." 
