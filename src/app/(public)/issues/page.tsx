...
import {
  Plus, LayoutGrid, AlertCircle, Zap, MessageSquare,
  Send, Loader2, CheckCircle2, Clock, Filter,
  ChevronLeft, ChevronRight, MapPin, Image as ImageIcon,
  MoreHorizontal, Search, X, Calendar, User, Tag, MessageCircle
} from "lucide-react";
...
// --- Issue Create Modal (Enhanced) ---
function IssueCreateModal({ onSuccess }: { onSuccess: () => void }) {
