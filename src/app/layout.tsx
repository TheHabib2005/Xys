...
export default async function RootLayout({
  ...
  // Optional: theme state for dynamic logo switching
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        {/* SVG Logo */}
        <link rel="icon" type="image/svg+xml" href={"/icons/icon1.svg"} />

        {/* Optional alternate icon */}
        <link rel="alternate icon" type="image/svg+xml" href="/icons/icon0.svg" />
      </head>
